...
public class SqliteDbHelper extends SQLiteOpenHelper {
  ...
  private static final String SQL_CREATE_STORIES_COMMENTS=
      "CREATE TABLE " + StoryCommentContract.StoryCommentColumns.TABLE_NAME + " (" +
          StoryCommentContract.StoryCommentColumns._ID + " INTEGER PRIMARY KEY," +
          StoryCommentContract.StoryCommentColumns.COLUMN_NAME_STORYID+ INT_TYPE + COMMA_SEP +
          StoryCommentContract.StoryCommentColumns.COLUMN_NAME_COMMENTID+ INT_TYPE +
          " )";
